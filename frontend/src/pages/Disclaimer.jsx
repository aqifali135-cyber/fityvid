...
export default function Disclaimer() {
  return (
    <>
      <SEO title="Disclaimer" description="FityVid legal disclaimer." />
      <PolicyLayout title="Disclaimer">
        <div className="notice-box" style={{ marginBottom: '1.5rem' }}>
          <p style={{ margin: 0 }}>
            <strong>FityVid supports YouTube, TikTok, Instagram, and Facebook links only.</strong>{' '}
        ...
        <p>
          ...
          FityVid processes publicly accessible content only. We do not support private videos,
        ...
        <p>
          All trademarks belong to their respective owners. FityVid is an independent website
          and is not endorsed by any social media platform.
        </p>
      </PolicyLayout>
    </>
  );

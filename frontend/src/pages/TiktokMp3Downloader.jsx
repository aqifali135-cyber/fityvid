...
export default function TiktokMp3Downloader() {
  return (
    <>
      <SEO
        title="TikTok MP3 Downloader | FityVid"
        description="TikTok MP3 Downloader on FityVid — this tool is coming soon."
      ...
      <section className="ttcs-page section">
        ...
        <div className="container ttcs-page__inner">
          ...
          <h1 className="ttcs-page__title">TikTok MP3 Downloader</h1>
